...
This repository contains a Codex skill for running a structured Harness Engineering workflow. Use it for tasks that need explicit owners, workflow artifacts, validation gates, and a repo-centered operating model instead of a one-off chat response.
