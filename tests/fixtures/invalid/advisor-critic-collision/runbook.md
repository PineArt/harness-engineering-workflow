# Advisor Critic Collision

Run ID: advisor-critic-collision
Telemetry Mode: Off
...
Critic | Opus Advisor | external advisor session | No | invalidly reuses advisor as critic owner
...
Verdict: Pass
Evidence: should fail because Advisor and Critic are the same owner.
